package com.tonywww.elementalemerge.particle;
...
public class ElectricParticle extends TextureSheetParticle {
    ...
    protected ElectricParticle(ClientLevel world, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed, SpriteSet spriteSet) {
    ...
    public static class Factory implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(@NotNull SimpleParticleType typeIn, @NotNull ClientLevel worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            ElectricParticle heartParticle = new ElectricParticle(worldIn, x, y, z, xSpeed, ySpeed, zSpeed, this.spriteSet);
